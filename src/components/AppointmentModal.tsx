...
import { X, Calendar, Clock, User, Phone, Sparkles, CheckCircle2, MessageSquare, ArrowRight } from 'lucide-react';
  ...
  return (
    ...
    >
      <div
        ...
        className="relative bg-[#FAF8F5] rounded-3xl max-w-xl w-full p-6 sm:p-9 shadow-2xl border border-[#D8C9B8] my-8 overflow-hidden"
      ...
      >
        ...
        <button
          ...
          className="absolute top-5 right-5 p-2 rounded-full text-[#8D8176] hover:text-[#2A211D] hover:bg-[#EEE8DF] transition-colors cursor-pointer"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        {!isSubmitted ? (
          <div>
            ...
            <div className="mb-6 pr-6">
              ...
              <p className="text-xs sm:text-sm text-[#8D8176] mt-1 font-light">
                Select your preferred service, date, and time. Our concierge will reach out to confirm your slot.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center pt-1">
                <span className="text-[11px] text-[#8D8176]">
                  ...
                  <a href={`tel:${BUSINESS_INFO.phone}`} className="font-semibold text-[#2A211D] underline">
                    {BUSINESS_INFO.phone}
                  </a>
                </span>
              </div>
          ...
          <div className="text-center py-6">
            ...
            <p className="text-sm text-[#8D8176] max-w-md mx-auto leading-relaxed mb-6 font-light">
              Your appointment request for <strong className="text-[#2A211D] font-semibold">{formData.serviceName}</strong> on <strong className="text-[#2A211D] font-semibold">{formData.date} at {formData.timeSlot}</strong> has been received. Our salon team will contact you shortly at <strong className="text-[#2A211D] font-semibold">{formData.phone}</strong> to confirm your booking.
            </p>
            ...
            <div className="bg-[#EEE8DF]/50 p-4 rounded-2xl border border-[#D8C9B8]/50 max-w-sm mx-auto mb-6 text-left text-xs space-y-1.5 text-[#2A211D]">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-right">DLF Phase 3, Gurugram</span>
              </div>
              <div className="flex justify-between">
